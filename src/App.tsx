      ...
      <footer className="border-t border-[#23272F] bg-[#16181D] py-5 text-xs text-slate-400">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center space-x-2.5">
            ...
            <span className="font-semibold text-slate-200 text-xs">GLSL to Unity SRP Migration Engine</span>
            <span className="text-slate-600">•</span>
            <span className="text-slate-400 text-[11px]">Unity 2022.3 LTS, 2023.3 & Unity 6 (6000 LTS)</span>
          </div>
